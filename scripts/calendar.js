...
// const calendarID = '27e33a86803a5163777fdb15e211ce3473250b442648ac8a91c02859ae85334c@group.calendar.google.com';
...
//  * @param {string} date - Fecha y hora de inicio del evento en formato ISO (e.g., '2024-06-)
...
//                 timeZone: timeZone,
//             },
//             colorId: '2' // Color en Google Calendar
//         };
...
//         console.log("Evento creado con éxito URL: ", eventId);
//         return eventId;
//     } catch (err) {
//         console.error('Hubo un error al crear el evento en el servicio de Calendario: ' + err);
//         throw err;
//     }
// }
...
//         // Definir fecha de fin si no se pronuncia
//         if (!endDate) {
...
//  * @param {string|Date} date - Fecha a partir de la cual buscar el próximo slot disponible
...
// /**
//  * Verificar si hay slots disponibles para una fecha dada.
...
//         // Obten todos los slots disponibles desde la fecha actual hasta el límite definido.
